        ...
        <div class="row">
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tabFB">
                  ...
                  <div class="box-body">              
                <table id="list-topic-fb" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Nama Topic</th>
                  ...
                  <tbody>
                  @foreach ($topic['data'] as $topics)
                  <tr>
                      <td>{{$topics['topic_id']}}</td>
                      <td>{{$topics['t_name']}}</td>
                      <td></td>
                    </tr>
                    @endforeach
                      ...
                      <div class="form-group">
                        <label>Start Date</label>
                          <div class="input-group date">
                            ...
                            <input type="date" class="form-control pull-right" id="datepicker3">
                          </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                          <label>End Date</label>
                            <div class="input-group date">
                              ...
                              <input type="date" class="form-control pull-right" id="datepicker4">
                            </div>
                        </div>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        <label>Start Date</label>
                          <div class="input-group date">
                            ...
                            <input type="date" class="form-control pull-right" id="datepicker5">
                          </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                          <label>End Date</label>
                            <div class="input-group date">
                              ...
                              <input type="date" class="form-control pull-right" id="datepicker6">
                            </div>
                        </div>
                    </div>
                  </div>
          ...
          <div class="col-md-7">
            <div class="box">
              ...
              <!-- /.box-header -->
              <div class="box-body">              
                <table id="antrian-tools-ipa" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Platform</th>
                  ...
                  <tbody>
                  @foreach ($queue['data'] as $queues)
                  <tr>
                      <td>{{$queues['criteria_id']}}</td>
                      <td>{{$queues['platform']}}</td>
                      <td>{{$queues['criteria']}}</td>
                      <td>{{$queues['mode']}}</td>
                      <td>{{$queues['criteria_name']}}</td>
                      <td>@if ($queues['status'] == '1') <i>Done</i> @else <i>Proses</i> @endif</td>
                      <td>{{$queues['timeframe']}}</td>
                      <td>{{ date("F d, Y", strtotime($queues['pubminute'])) }}</td>
                    </tr>
                    @endforeach
                  </tbody>                 
                </table>
